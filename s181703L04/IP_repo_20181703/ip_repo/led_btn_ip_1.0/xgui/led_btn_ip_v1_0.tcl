...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "BTN_WIDTH"

}

proc update_PARAM_VALUE.BTN_WIDTH { PARAM_VALUE.BTN_WIDTH } {
	# Procedure called to update BTN_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BTN_WIDTH { PARAM_VALUE.BTN_WIDTH } {
	# Procedure called to validate BTN_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.BTN_WIDTH { MODELPARAM_VALUE.BTN_WIDTH PARAM_VALUE.BTN_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BTN_WIDTH}] ${MODELPARAM_VALUE.BTN_WIDTH}
}
